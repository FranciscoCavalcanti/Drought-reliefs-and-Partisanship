...
gen mod_alt_aligned=(mod_alt==1 & alg_mv_bm_party==1)
gen mod_alt_notaligned=(mod_alt==1 & alg_mv_bm_party==0)

gen sev_alt_aligned=(sev_alt==1 & alg_mv_bm_party==1)
gen sev_alt_notaligned=(sev_alt==1 & alg_mv_bm_party==0)
