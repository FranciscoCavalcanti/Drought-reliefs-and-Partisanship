	...
	* calculate bandwidth
	rdbwselect relief_mv_bp mv_bp_party_P1 if mv_bp_party_P1 != . & spi_range == "<-1.2" , all
	...
	* calculate bandwidth
	rdbwselect relief_mv_bp mv_bp_party_P1 if mv_bp_party_P1 != . & spi_range == "-1.0" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
	...
	* calculate bandwidth
	rdbwselect relief_mv_bp mv_bp_party_P1 if mv_bp_party_P1 != . & spi_range == "-0.8" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
	...
	* calculate bandwidth
	rdbwselect relief_mv_bp mv_bp_party_P1 if mv_bp_party_P1 != . & spi_range == "-0.6" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
	...
	* calculate bandwidth
	rdbwselect relief_mv_bp mv_bp_party_P1 if mv_bp_party_P1 != . & spi_range == "-0.4" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
	...
	* calculate bandwidth
	rdbwselect relief_mv_bp mv_bp_party_P1 if mv_bp_party_P1 != . & spi_range == "-0.2" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
	...
	* calculate bandwidth
	rdbwselect relief_mv_bp mv_bp_party_P1 if mv_bp_party_P1 != . & spi_range == "0.0" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
...
***************************
	...
	***************************
	set scheme  s1mono  
		...
		*/	xtitle("Standardised Precipitation Index") 	/*
		...
		*/ 		/*  
		*/ 	  	/*
		*/ 	saving("$tmp\_graph_range_spi_bp.gph", replace) 
