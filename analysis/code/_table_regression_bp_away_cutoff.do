...
keep if relief_mv_bp!=.
drop if ( mv_bp_party_P1 <= $CCT_party &   mv_bp_party_P1 >= -$CCT_party) 
...
outreg2	using "$outdir/regressions/_table_regression_mv_bp_away_cutoff.tex", /*
	*/	title("") /*	
	*/	level(95) /*
	*/	dec(3) /*
	*/	fmt(fc) /*
	...
	*/	addtext(Year FE, No, Municipality FE, No ) /*
	*/	tex(fragment) /*
	*/	replace
...
outreg2	using "$outdir/regressions/_table_regression_mv_bp_away_cutoff.tex", /*
	...
	*/	addstat("(1) F statistics (aligned and low = non-aligned and low):", `Fstatistics_low', 	/*
		...
		*/ 	"(3) F statistics (aligned and severe = non-aligned and severe)", `Fstatistics_severe', 	/*	
		*/ 	"(3) \hspace{1mm} P-values", `two_sided_pvalue_severe')	 /*	
	*/	addtext(Year FE, Yes, Municipality FE, No ) /*
	*/	tex(fragment) /*
	*/	 
...
severe_aligned severe_notaligned ///
 /// d_munic_*
, cluster(cod_mun) absorb(cod_mun) 
...
outreg2	using "$outdir/regressions/_table_regression_mv_bp_away_cutoff.tex", /*
	...
	*/	addstat("(1) F statistics (aligned and low = non-aligned and low):", `Fstatistics_low', 	/*
		...
		*/ 	"(3) F statistics (aligned and severe = non-aligned and severe)", `Fstatistics_severe', 	/*	
		*/ 	"(3) \hspace{1mm} P-values", `two_sided_pvalue_severe')	 /*	
	*/	addtext(Year FE, No, Municipality FE, Yes ) /*
	*/	tex(fragment) /*
	*/	 
