...
**** 
	...
	* calculate bandwidth
	rdbwselect relief_mv_bm mv_bm_party_P1 if mv_bm_party_P1 != . & spei_range == "<-1.2" , all
	...
	* calculate bandwidth
	rdbwselect relief_mv_bm mv_bm_party_P1 if mv_bm_party_P1 != . & spei_range == "-1.0" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
	...
	* calculate bandwidth
	rdbwselect relief_mv_bm mv_bm_party_P1 if mv_bm_party_P1 != . & spei_range == "-0.8" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
	...
	* calculate bandwidth
	rdbwselect relief_mv_bm mv_bm_party_P1 if mv_bm_party_P1 != . & spei_range == "-0.6" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
	...
	* calculate bandwidth
	rdbwselect relief_mv_bm mv_bm_party_P1 if mv_bm_party_P1 != . & spei_range == "-0.4" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
	...
	* calculate bandwidth
	rdbwselect relief_mv_bm mv_bm_party_P1 if mv_bm_party_P1 != . & spei_range == "-0.2" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
	...
	* calculate bandwidth
	rdbwselect relief_mv_bm mv_bm_party_P1 if mv_bm_party_P1 != . & spei_range == "0.0" , all
	macro drop CCT_party
	global CCT_party = e(h_CCT) 
	global CCT_party : display %9.3fc $CCT_party
	display $CCT_party
...
***************************
	...
	***************************
	...
	coefplot q8 q9 q10 q11 q12 q13 q14 q15 q16 q17 q18 q19 q20 q21 /*
		...
		*/ 		/*  
		*/ 	  	/*
		*/ 	saving("$tmp\_graph_range_spei_bm.gph", replace) 