...
gen mod_alt1_aligned=(mod_alt1==1 & alg_mv_bp_party==1)
gen mod_alt1_notaligned=(mod_alt1==1 & alg_mv_bp_party==0)

gen mod_alt2_aligned=(mod_alt2==1 & alg_mv_bp_party==1)
gen mod_alt2_notaligned=(mod_alt2==1 & alg_mv_bp_party==0)

gen sev_alt1_aligned=(sev_alt1==1 & alg_mv_bp_party==1)
gen sev_alt1_notaligned=(sev_alt1==1 & alg_mv_bp_party==0)

gen sev_alt2_aligned=(sev_alt2==1 & alg_mv_bp_party==1)
gen sev_alt2_notaligned=(sev_alt2==1 & alg_mv_bp_party==0)
